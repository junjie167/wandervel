            ...
            <section>
                ...
                <div class="signup-title">
                    ...
                    <form id="registerform" name="registerform" action="registerProcess.php" method="POST">
                        ...
                        <div class="form-group">
                            <label style="font-size: 20px;" for="confirmPassword">Confirm Password:</label>
                            <input class="form-control" id="confirmPassword" type="password" name="confirmPassword" placeholder="Enter Confirm Password" required/>
                        </div>

                        <div class="form-group">
                            <label style="font-size: 20px;" for="gender">Gender:
